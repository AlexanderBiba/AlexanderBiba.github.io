    ...
    return (
        <section id="works">
            ...
            <div className="content">
                ...
                <p>A method to increase motivation to complete daily tasks by working with a partner, React.js, Firebase DB, Material UI.</p>
                ...
                <p>A classic wordle game with a new word every day, React.js.</p>
