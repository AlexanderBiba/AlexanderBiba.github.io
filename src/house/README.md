...
The backyard chess table replaces the birdbath by the fence. Its Chess.com link reads `chess` from `content/site.json`; the upstairs printer’s YouTube link reads `youtube3dPrinting`. Update those full URLs when either profile changes.
