...
export const stories: Record<string, Story> = {
  ...
  bed: { id: 'bed', title: 'ALEX', text: 'I’m Alex. Engineer, husband, dad. This is my place.', links: [{ label: 'GitHub', href: profile.github }, { label: 'X (Twitter)', href: profile.twitter }, { label: 'Email', href: `mailto:${profile.email}` }] },
  ...
  picnic: { id: 'picnic', title: 'ALEX', text: 'Have something in mind? Send me a message.', links: [{ label: 'Email', href: `mailto:${profile.email}` }, { label: 'LinkedIn', href: profile.linkedin }, { label: 'GitHub', href: profile.github }, { label: 'X (Twitter)', href: profile.twitter }] },
